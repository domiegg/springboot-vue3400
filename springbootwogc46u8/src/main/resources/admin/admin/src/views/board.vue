		...
		<div :style='{"padding":"20px 20px 0","display":"flex","height":"calc(100vh - 95px)"}'>
			<div :style='{"width":"30%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="jinanlvyouChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","margin":"0 0 0px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"85%"}'>
						<div id="jinanlvyouChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
				...
				<div :style='{"alignContent":"center","padding":"0","margin":"0 0 20px 0","color":"#fff","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","height":"100px","order":"1"}'>
					...
					<div :style='{"margin":"0 10px 0 0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231223/9c1f0d184ede4dee8925bb6c57ba14b7.png) no-repeat center top / 100% 100%","flexDirection":"column","flex":"1","display":"flex","width":"calc(20% - 10px)","justifyContent":"center","height":"100%"}'>
						...
						<div :style='{"padding":"0 0px","alignItems":"center","flexDirection":"column-reverse","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>国内旅游总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{jinanlvyouCount}}</div>
						</div>
					</div>
				</div>
				<div class="tables">
					<div :style='{"margin":"0 0 20px 0","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","width":"100%","fontSize":"16px","height":"42px"}'>国内旅游(评分TOP10)</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"rgba(92,135,230,.3)","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
						...
						<el-table-column :resizable="true" :sortable="false" prop="renshu" label="打分人数"/>
						</el-table-column>
					</el-table>
				</div>
			</div>
			<div :style='{"width":"30%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts3">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="jinanlvyouChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts4">
					<div :style='{"width":"100%","margin":"0 0 0px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="jinanlvyouChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="jinanlvyouChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
...
export default {
  ...
  created() {
    this.$nextTick(()=>{
		this.times()
		setTimeout(()=>{
			this.getjinanlvyouCount();
			this.jinanlvyouChat1();
			this.jinanlvyouChat4();
			this.jinanlvyouChat3();
			this.jinanlvyouChat2();
			this.jinanlvyouChat5();
		},500)
	})
  },
  methods:{
    ...
    getjinanlvyouCount() {
        this.$http({
            url: `jinanlvyou/count`,
            method: "get"
        }).then(({
            data
        }) => {
            if (data && data.code == 0) {
                this.jinanlvyouCount = data.data
            }
        })
    },
...
//统计接口1
    jinanlvyouChat1() {
      this.$nextTick(()=>{
        ...
        var jinanlvyouChart1 = echarts.init(document.getElementById("jinanlvyouChart1"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                jinanlvyouChart1.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    jinanlvyouChart1.resize();
                },false);
            }
        });
      })
...
//统计接口2
    jinanlvyouChat4() {
      this.$nextTick(()=>{
        ...
        var jinanlvyouChart4 = echarts.init(document.getElementById("jinanlvyouChart4"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                jinanlvyouChart4.setOption(option);
				
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, jinanlvyouChart4)

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    jinanlvyouChart4.resize();
                },false);
            }
        });
      })
...
//统计接口3
    jinanlvyouChat3() {
      this.$nextTick(()=>{
        ...
        var jinanlvyouChart3 = echarts.init(document.getElementById("jinanlvyouChart3"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                var option = {};
				let titleObj = this.line4?this.line4.title:this.line.title
				titleObj.text = '打分人数统计'
				
				const legendObj = this.line4?this.line4.legend:this.line.legend
				...
				let yAxisObj = this.line4?this.line4.yAxis:this.line.yAxis
				yAxisObj.type = 'value'
				...
				seriesObj = Object.assign(seriesObj , this.line4?this.line4.series:this.line.series)
                ...
                option = {
					backgroundColor: this.line4?this.line4.backgroundColor:this.line.backgroundColor,
					color: this.line4?this.line4.color:this.line.color,
                    title: titleObj,
					legend: legendObj,
                    tooltip: tooltipObj,
					grid: gridObj,
                ...
                // 使用刚指定的配置项和数据显示图表。
                jinanlvyouChart3.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    jinanlvyouChart3.resize();
                },false);
            }
        });
      })
...
//统计接口4
    jinanlvyouChat2() {
      this.$nextTick(()=>{
        ...
        var jinanlvyouChart2 = echarts.init(document.getElementById("jinanlvyouChart2"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                jinanlvyouChart2.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    jinanlvyouChart2.resize();
				},false);
            }
        });
      })
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                var option = {};
                this.wordclouds(pArray,'jinanlvyouChart5');
